...
export const createMedia = (data, urlImage, urlVideo, mainPhotograph, photos, video) => {
    ...
    mediaTitle.innerHTML = data.title
    mediaPrice.innerHTML = data.price + " €"
    mediaNbLike.innerHTML = data.likes
